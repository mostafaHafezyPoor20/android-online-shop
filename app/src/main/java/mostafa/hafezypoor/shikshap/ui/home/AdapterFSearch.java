...
public  class AdapterFSearch extends RecyclerView.Adapter<AdapterFSearch.ViewHolder>{
    private Context context;
    private List<ModelDetailProduct>list;

    public AdapterFSearch(Context context, List<ModelDetailProduct> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.adapter_fsearch,parent,false));
    }
